...
import'package:design/screens/auth_screens/auth_screen.dart';
...
import'package:design/models/dio_error_model.dart';
import'package:design/utils/common/app_config.dart';
import'package:design/utils/common/app_snackbar.dart';
...
class HttpService {
  ...
  Future<Response> get({
    ...
    try {
      return await _dio.get(endPoint,queryParameters: queryParameters,data: data);
...
void responseErrorHandler(
  ...
  if (response?.statusCode == 200) {
    ...
    /// Force user to login if server error occurs
    forceToLogin();
...
Future<void> forceToLogin() async {
  ...
  if (globalBuildContextExits) {
    ...
    if (globalBuildContext.mounted) {
      ...
      globalBuildContext.pushAndRemoveUntil(LoginScreen());
    }
  }
}
