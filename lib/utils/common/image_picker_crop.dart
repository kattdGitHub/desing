...
import 'package:design/utils/common/permission_denied_dialogs.dart';
...
Future<File?> getImageCropperPicker(
    {bool imageFromCamera = true, bool cropImage = true}) async {
  try {
    final cameraPermission = await getAnyPermission(
      context: globalBuildContext,
      permissionType: imageFromCamera
          ? Permission.camera
          : Platform.isIOS
              ? Permission.photos
